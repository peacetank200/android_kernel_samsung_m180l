...
bool sec_battery_get_jig_status(void)
{
	return fsa9480_jig_status;
}
EXPORT_SYMBOL(sec_battery_get_jig_status);
...
#else // kyNam_111228_ Increase Current of GPIO (CMC623)
	{
		.num	= S5PV210_GPC1(1),
		.cfg	= S3C_GPIO_OUTPUT,
		.val	= S3C_GPIO_SETPIN_NONE,
...
// worked here, 2010. 11. 03  13:14 john
...

	{
		...
		.val	= S3C_GPIO_SETPIN_NONE,
		.pud	= S3C_GPIO_PULL_DOWN,
#if defined(CONFIG_KOR_MODEL_M180L)
		.drv	= S3C_GPIO_DRVSTR_4X,
#else		
		.drv	= S3C_GPIO_DRVSTR_1X,
#endif		
...
#if defined(CONFIG_KOR_MODEL_M180L)
static unsigned int p1_r17_sleep_gpio_table[][3] = {
	{S5PV210_MP01(5),  // NANDCS
			S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},  

	{S5PV210_MP01(5),  // ONAND_RE
			S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},  
	{S5PV210_MP01(5),  // ONAND_WE
			S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},  

	{S5PV210_MP02(3),  // ONAND_READY
			S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},   
	{S5PV210_MP03(0),  // ONAND_AVDO
			S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},   
	{S5PV210_MP03(1),  // ONAND_CLK
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},   


	{S5PV210_MP03(5),  // ONAND_INT
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},    
	{S5PV210_MP03(6),  // TP_ONAND_INT
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},  
	{S5PV210_MP05(1),  // NC
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},   
	{S5PV210_MP05(5),  // NC
	...
	{S5PV210_MP06(0),  // ONAND_AD(0)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP06(1),   // ONAND_AD(1)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP06(2),   // ONAND_AD(2)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP06(3),   // ONAND_AD(3)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP06(4),   // ONAND_AD(4)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP06(5),   // ONAND_AD(5)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP06(6),   // ONAND_AD(6)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP06(7),   // ONAND_AD(7)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 

	{S5PV210_MP07(0),   // ONAND_AD(8)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP07(1),   // ONAND_AD(9)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP07(2),   // ONAND_AD(10)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP07(3),   // ONAND_AD(11)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP07(4),   // ONAND_AD(12)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP07(5),   // ONAND_AD(13)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP07(6),   // ONAND_AD(14)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP07(7),   // ONAND_AD(15)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 			
};
#endif
...
#if defined(CONFIG_KOR_MODEL_M180L)
      if(HWREV >= 17) {  // P1 LGU rev 0.1
			s3c_config_sleep_gpio_table(ARRAY_SIZE(p1_r17_sleep_gpio_table),
				p1_r17_sleep_gpio_table);
       }
#endif
#endif
