...
#define CMD_CODEC_EMERGENCY_RECOVERY 14 // Emergency recovery for Error like -EIO, -ESTRPIPE, and etc.
...
void wm8994_Vcall_recording_change_path(struct snd_soc_codec *codec);
#endif
